...
{
  "$end", "error", "$undefined", "INCLUDE", "DEFINE", "RETURN", "IF",
  "ELSE", "FOR", "WHILE", "INT", "FLOAT", "DOUBLE", "CHAR", "VOID", "TRUE",
...
#line 62 "./src/parser.y"
        {
            if ((yyvsp[-1].char_val) == '+') (yyval.int_val) = (yyvsp[-2].int_val) + (yyvsp[0].int_val);
